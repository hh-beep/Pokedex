    ...
    favoritos.forEach(pokemon => {
      ...
      li.innerHTML = `
        <div class="main_List__Card-Top">
          ...
          <button class="Favoritos_Card--Remover" data-name="${pokemon.name}" title="Remover dos favoritos">
            <!-- Você pode usar um ícone SVG ou emoji -->
            <img src="./assets/icon_star.svg" alt="Remover" style="filter: brightness(0) saturate(100%) invert(85%) sepia(90%) saturate(1000%) hue-rotate(360deg);">
          </button>
        </div>
